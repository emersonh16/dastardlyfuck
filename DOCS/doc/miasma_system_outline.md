...
- **Clearing:** Instant removal when beam hits
...
- **Load Distance:** 2 chunks beyond viewport
- **Management:** Load/unload chunks as camera moves
...
### Phase 1: Foundation
1. Set up 3D project with orthographic isometric camera
2. Create MiasmaManager (Autoload singleton)
3. Create MiasmaChunk data class
4. Implement basic chunk loading/unloading
